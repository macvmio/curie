...
public enum ClipboardConstants {
    ...
    public static let magic: UInt32 = 0x4355_5249

    /// Virtio socket port for clipboard sync
    public static let port: UInt32 = 52525
...
public enum ClipboardMessageType: UInt8 {
...
public struct ClipboardContent: Codable, Equatable {
    ...
    public init(type: ClipboardContentType, data: Data, changeCount: Int) {
        self.type = type
        self.data = data
...
public struct ClipboardMessage {
    public var type: ClipboardMessageType
    public var sequenceNumber: UInt32
    public var payload: Data

    public init(type: ClipboardMessageType, sequenceNumber: UInt32, payload: Data = Data()) {
        self.type = type
    ...
    public static func decode(from data: Data) -> (message: ClipboardMessage, bytesConsumed: Int)? {
